...
public class CanceledOrdersForAPeriodOfTime implements IAction {
	...
	public void execute() {
		...
		System.out.println("Canceled orders: " + facade.orderService.getCanceledOrdersForAPeriodOfTime(
